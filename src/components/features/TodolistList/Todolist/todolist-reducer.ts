...
import {RequestStatusType, setAppStatusAC, SetStatusActionType} from "../../../app/app-reducer/AppReducer";
...
export const getTodolistTC = () => (dispatch: Dispatch<ActionsTypes | SetStatusActionType>) => {
...
export const createTodolistTC = (title: string) => (dispatch: Dispatch<ActionsTypes | SetStatusActionType>) => {
    dispatch(setAppStatusAC('loading'))
...
export const deleteTodolistTC = (todolistId: string) => (dispatch: Dispatch<ActionsTypes | SetStatusActionType> ) => {
    dispatch(setAppStatusAC("loading"))
